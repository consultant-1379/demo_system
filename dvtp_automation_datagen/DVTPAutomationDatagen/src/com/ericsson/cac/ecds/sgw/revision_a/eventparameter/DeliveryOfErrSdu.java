...
public class DeliveryOfErrSdu extends SgwUint{

    public DeliveryOfErrSdu()
    {
        hasValidityBit = false;
        isValid = true;
    }

    public DeliveryOfErrSdu(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public DeliveryOfErrSdu(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public DeliveryOfErrSdu(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public DeliveryOfErrSdu(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public DeliveryOfErrSdu(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    {
        return "Delivery_Of_Err_Sdu";
    }

    public String getDescription()
    {
        return "Delivery of erroneous SDUs in R99 QoS profile.";
    }
    ...
    private static final String name = "Delivery_Of_Err_Sdu";
    private static final String shortName = "Delivery_Of_Err_Sdu";
    private static final String description = "Delivery of erroneous SDUs in R99 QoS profile.";
