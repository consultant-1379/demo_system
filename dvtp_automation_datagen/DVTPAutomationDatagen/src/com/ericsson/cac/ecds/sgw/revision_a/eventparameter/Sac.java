...
public class Sac extends SgwUint
{
    ...
    public Sac(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public Sac(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public Sac(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public Sac(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public Sac(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "Sac";
    private static final String shortName = "Sac";
    private static final String description = "Sac.";
