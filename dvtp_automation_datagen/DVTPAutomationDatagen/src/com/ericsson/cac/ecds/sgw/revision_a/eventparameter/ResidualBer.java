...
public class ResidualBer extends SgwUint{
    ...
    public ResidualBer(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public ResidualBer(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public ResidualBer(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public ResidualBer(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public ResidualBer(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    {
        return "Residual Bit Error Rate in R99 QoS profile.";
    }
    ...
    private static final String name = "Residual_Ber";
    private static final String shortName = "Residual_Ber";
    private static final String description = "Residual Bit Error Rate in R99 QoS profile.";
