...
public class Rac extends SgwUint
{
    ...
    public Rac(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public Rac(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public Rac(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public Rac(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public Rac(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "Rac";
    private static final String shortName = "Rac";
    private static final String description = "Rac";
