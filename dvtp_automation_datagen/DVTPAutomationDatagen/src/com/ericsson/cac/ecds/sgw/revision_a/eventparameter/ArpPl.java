...
public class ArpPl extends SgwUint{
    ...
    public ArpPl(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public ArpPl(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public ArpPl(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public ArpPl(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public ArpPl(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    {
        return "Provides information on Priority Level of Allocation and Retention Priority for each bearer in a bearer setup list";
    }
    ...
    private static final String name = "Arp_Pl";
    private static final String shortName = "Arp_Pl";
    private static final String description = "Provides information on Priority Level of Allocation and Retention Priority for each bearer in a bearer setup list";
    private static final String comment = "";
    private static final int lengthBits = 0;
    private static final int validLow = 1;
