...
public class GbrDl extends SgwUint{
    ...
    public GbrDl(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public GbrDl(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public GbrDl(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public GbrDl(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public GbrDl(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "Gbr_Dl";
    private static final String shortName = "Gbr_Dl";
