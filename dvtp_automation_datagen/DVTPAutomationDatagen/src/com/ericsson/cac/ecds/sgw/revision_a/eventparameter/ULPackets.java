...
public class ULPackets extends SgwUint
{
    ...
    public ULPackets(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public ULPackets(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public ULPackets(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public ULPackets(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public ULPackets(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "ULPackets";
    private static final String shortName = "ULPackets";
    private static final String description = "Indicates how many packets that have been forwarded by the EPG in the uplink direction for the bearer.";
