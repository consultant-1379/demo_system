...
public class MbrDl extends SgwUint{
    ...
    public MbrDl(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public MbrDl(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public MbrDl(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public MbrDl(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public MbrDl(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "Mbr_Dl";
    private static final String shortName = "Mbr_Dl";
