...
public class Lac extends SgwUint
{
    ...
    public Lac(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public Lac(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public Lac(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public Lac(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public Lac(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "Lac";
    private static final String shortName = "Lac";
    private static final String description = "LAC";
