...
public class ReliabilityClass extends SgwUint{

    public ReliabilityClass()
    {
        hasValidityBit = false;
        isValid = true;
    }

    public ReliabilityClass(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public ReliabilityClass(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public ReliabilityClass(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public ReliabilityClass(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public ReliabilityClass(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    {
        return "Reliability Class in R97/98 QoS profile.";
    }
    ...
    private static final String name = "Reliability_Class";
    private static final String shortName = "Reliability_Class";
    private static final String description = "Reliability Class in R97/98 QoS profile.";
