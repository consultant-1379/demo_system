...
public class RatingGroup extends SgwUint
{
    ...
    public RatingGroup(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public RatingGroup(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public RatingGroup(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public RatingGroup(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public RatingGroup(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "RatingGroup";
    private static final String shortName = "RatingGroup";
