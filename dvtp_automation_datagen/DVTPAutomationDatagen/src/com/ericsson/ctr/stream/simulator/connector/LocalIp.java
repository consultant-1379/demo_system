...
public class LocalIp extends Connector {
	...
	public void showHelp () {
		System.out.println(
				"Connector : LocalIp\n" +
				"    --host=<host> --port=<port> --bindaddr=<address list>");
		super.showHelp ();
	}
	...
	public boolean processArgs (String par, String val) {
		...
		if (par.equals("--host")) {
			...
			return true;
		} else if (par.equals("--bindaddr")) {
			this.bindAddrs = val.split (",");
		    return true;
		}
	...
	public ConnectorItem create () {
        ...
        try {
            ...
            if (this.debug) {
            	...
            	System.out.println ("D bind address '" + this.bindAddrs [this.bindAddrsIx].toString() + "'");
            }
