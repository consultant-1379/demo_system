...
public class GbrUl extends SgwUint{
    ...
    public GbrUl(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public GbrUl(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public GbrUl(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public GbrUl(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public GbrUl(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "Gbr_Ul";
    private static final String shortName = "Gbr_Ul";
