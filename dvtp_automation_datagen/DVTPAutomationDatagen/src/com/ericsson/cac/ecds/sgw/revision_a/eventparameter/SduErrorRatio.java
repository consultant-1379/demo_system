...
public class SduErrorRatio extends SgwUint{

    public SduErrorRatio()
    {
        hasValidityBit = false;
        isValid = true;
    }

    public SduErrorRatio(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public SduErrorRatio(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public SduErrorRatio(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public SduErrorRatio(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public SduErrorRatio(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    {
        return "Sdu_Error_Ratio";
    }

    public String getDescription()
    {
        return "SDU error ratio in R99 QoS profile.";
    }
    ...
    private static final String name = "Sdu_Error_Ratio";
    private static final String shortName = "Sdu_Error_Ratio";
    private static final String description = "SDU error ratio in R99 QoS profile.";
