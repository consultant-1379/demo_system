...
public class SourceStatisticsDescriptor extends SgwUint{

    public SourceStatisticsDescriptor()
    {
        hasValidityBit = false;
        isValid = true;
    }

    public SourceStatisticsDescriptor(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public SourceStatisticsDescriptor(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public SourceStatisticsDescriptor(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public SourceStatisticsDescriptor(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public SourceStatisticsDescriptor(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    {
        return "Source_Statistics_Descriptor";
    }

    public String getDescription()
    {
        return "Source Statistics Descriptor in R99 QoS profile.";
    }
    ...
    private static final String name = "Source_Statistics_Descriptor";
    private static final String shortName = "Source_Statistics_Descriptor";
    private static final String description = "Source Statistics Descriptor in R99 QoS profile.";
