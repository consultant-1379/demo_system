...
public class DLPackets extends SgwUint
{
    ...
    public DLPackets(boolean useValidityBit)
    {
        hasValidityBit = false;
        isValid = true;
    ...
    public DLPackets(Properties p, boolean useValidityBit)
    {
        super(p);
        hasValidityBit = false;
        isValid = true;
    ...
    public DLPackets(byte data[], int bitOffset, boolean useValidityBit)
    {
    ...
    public DLPackets(long newLong, boolean useValidityBit)
    {
        super(newLong);
        hasValidityBit = false;
        isValid = true;
    ...
    public DLPackets(String newString, boolean useValidityBit)
    {
        super(newString);
        hasValidityBit = false;
        isValid = true;
    ...
    private static final String name = "DLPackets";
    private static final String shortName = "DLPackets";
    private static final String description = "Indicates how many packets that have been forwarded by the EPG in the downlink direction for the bearer.";
